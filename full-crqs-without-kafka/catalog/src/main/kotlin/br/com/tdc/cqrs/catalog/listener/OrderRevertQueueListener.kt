...
@Service
class OrderRevertQueueListener(private val messageConverter: MessageConverter,
    ...
    override fun onMessage(message: Message?) {
        ...
        message?.let { it ->
            ...
            rabbitTemplate.convertAndSend(QueueCatalogDefinition.CATALOG_EXCHANGE, QueueCatalogDefinition.ORDER_QUEUE_INVALID_KEY, order)
