...
echo "********************************************************"
echo "Waiting for the AccountLegacy server to start on port $ACCOUNT_PORT"
echo "********************************************************"
while ! `nc -z accountlegacyservice $ACCOUNT_PORT`; do sleep 3; done
echo "*******  Account Legacy Server has started"
